...
def initDatabase():
	...
	Building.objects.create(name = _('Guild Emblem Template'), shortName = currentFam + '12', family = currentFam, parent = currentReq, cost = 100, isRepetable = False, completeDescr = _("Allows guild members to create a permanent guild emblem design at the Guild Registrar for use on banners and other displays."))
	...
	currentReq = basics.get(shortName = currentFam + '4')
	Building.objects.create(name = _('Guild Treasure Trove'), shortName = currentFam + '41', family = currentFam, parent = currentReq, isRepetable = False, cost = 5000, timeToBuild = 168, completeDescr = _("Grants access to a 100 slot Guild Vault"))
	currentReq = basics.get(shortName = currentFam + '5')
	Building.objects.create(name = _('Deep Cave'), shortName = currentFam + '51', family = currentFam, parent = currentReq, isRepetable = False, cost = 5000, timeToBuild = 168, completeDescr = _("The Deep Cave will expand your treasure trove by another 100 slots."))